...
<div class="space-y-6">
  ...
  <div class="bg-slate-800 p-6 rounded-2xl border border-white/5">
    <label class="text-sm font-medium text-slate-400 mb-4 flex items-center gap-2"><ImageIcon size={16} class="text-blue-400" /> {$t('settings.display.wallpaper')}</label>
  ...
  <div class="bg-slate-800 p-6 rounded-2xl border border-white/5">
    <label class="block text-sm font-medium text-slate-400 mb-2">{$t('settings.display.brightness')}</label>
  ...
  <div class="bg-slate-800 p-6 rounded-2xl border border-white/5">
    <label class="block text-sm font-medium text-slate-400 mb-2">{$t('settings.display.scale')}</label>
  ...
  <div class="grid grid-cols-2 gap-4">
    <div class="bg-slate-800 p-6 rounded-2xl border border-white/5">
      <label class="block text-sm font-medium text-slate-400 mb-2">{$t('settings.display.resolution')}</label>
    ...
    <div class="bg-slate-800 p-6 rounded-2xl border border-white/5">
      <label class="block text-sm font-medium text-slate-400 mb-2">{$t('settings.display.refresh_rate')}</label>
