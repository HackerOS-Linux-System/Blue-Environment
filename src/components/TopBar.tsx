...
const TopBar: React.FC<TopBarProps> = ({
    ...
    // Windows on the current workspace only for taskbar dots
    const currentWsWindows = openWindows.filter(w => w.workspace === currentWorkspace);
    ...
    return (
        <div className="absolute top-0 left-0 right-0 h-12 bg-slate-900/95 backdrop-blur-sm border-b border-white/5 flex items-center justify-between px-3 z-50 select-none">
            ...
            {/* ── Right: workspaces + weather + clock + notifications ── */}
